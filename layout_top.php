...
<head>
	...
	<link href="foto/logo2.png" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>JAWIR CAFE</strong></div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-th-large fa-fw"></i>&nbsp;Data Barang dan paket<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Data Paket") {
										echo '<li><a href="paket.php" class="active">Data Paket</a></li>';
									}
									else {
										echo '<li><a href="paket.php">Data Paket</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						<?php
