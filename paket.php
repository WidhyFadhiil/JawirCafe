										...
										<?php
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												echo '<td class="text-center">
													  <a href="paket_edit.php?js='. $data['id_brg'] .'" class="btn btn-warning btn-xs">Edit</a>';?>
													  <a href="paket_hapus.php?js=<?php echo $data['id_brg'];?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
